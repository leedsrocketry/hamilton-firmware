...
SOURCES ?=  src/main.c src/startup.c src/syscalls.c src/HAL/STM32_init.c src/drivers/MS5611_driver.c src/filters.c\
            ...
            src/flight_manager.c src/sensors.c src/drivers/HC12_driver.c src/drivers/_driver_manager.c src/buffer.c segger-rtt/RTT/SEGGER_RTT.c segger-rtt/RTT/SEGGER_RTT_printf.c src/lib/log.c src/HAL/NAND_flash_driver.c\
