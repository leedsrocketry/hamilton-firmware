/*
  ...
  Description: header file for the Pressure/Temp/humidity module BME280
  (https://www.mouser.co.uk/datasheet/2/783/bst_bme280_ds002-2238172.pdf)
*/
...
/**
  BME280_INTF_RET_TYPE is the read/write interface return type which can be
...
/**
 @brief Bus communication function pointer which should be mapped to the
...
/**
  ...
  @param reg_data Pointer to data buffer which is to be written in the regAddr
  of sensor.
...
/**
  @brief Reads the pres, temp and humidity data from the sensor, compensates the
  data and store it in the BME280_data structure instance passed by the user.
...
/**
  @brief Compensate the pres and/or temp and/or humidity data according to the
  selected component
  ...
  @param comp_data   : Contains the compensated pres and/or temp and/or humidity
  data
