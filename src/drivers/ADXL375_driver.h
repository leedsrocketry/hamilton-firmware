...
#define ADXL375_DATA_FORMAT_SETTINGS(self_test)                                                          \
  (ADXL375_DATA_FORMAT_FIXED | (self_test << ADXL375_DATA_FORMAT_SELF_TEST) |                            \
   (ADXL375_DATA_FORMAT_SPI_4_WIRE << ADXL375_DATA_FORMAT_SPI) | (0 << ADXL375_DATA_FORMAT_INT_INVERT) | \
...
/**
  ...
  @note This function should be called before attempting to read data from the
  accelerometer.
