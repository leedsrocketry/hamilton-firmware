...
// equivalent to 70 mdps/LSB, as specified in LSM6DSO datasheet section 4.1,
// symbol G_So
...
#define LSM6DSO_VAL_CTRL3_C_BDU \
  BIT(6)                                         // (bit 6) output registers are not updated until MSB and LSB have
                                                 // been read (prevents MSB from being updated while burst reading
                                                 // LSB/MSB)
