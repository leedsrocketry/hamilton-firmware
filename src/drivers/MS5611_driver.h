...
/**
  @brief Set the OSR (Oversampling rate). Setting another value from the
  enumeration will put the min OSR
...
/**
        ...
        @param calculate True if value needs to be updated. It will update the
   threes values
...
/**
        @brief Calculate/update the altitude/pressure/temperature using the
   barometer
*/
